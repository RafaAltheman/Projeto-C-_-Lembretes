...
int main() {
    ...
    while (1){
        ...
        if (opcao==0){
            ...
            editartarefa(&lt);
        } else if (opcao==5){ //Para o usuário salvar o arquivo, ele deve apertar a opção 4 ("Sair"), sendo que quando acessar o programa novamente, todas as informações fornecidas antes de sair serão listadas
